    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        search.addEventListener('input', () => {
            ...
            if (matches.length === 1) {
                ...
                selectedLabel.textContent = `Producto seleccionado: ${matches[0].dataset.label}.`;
            }
        });
        ...
        products.addEventListener('change', () => {
            ...
            if (selected?.value) {
                selectedFeedback.classList.remove('d-none');
                selectedLabel.textContent = `Producto seleccionado: ${selected.dataset.label}.`;
            } else {
