...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        search.addEventListener('input', () => {
            ...
            options.forEach((option) => option.hidden = term !== '' && !normalize(option.dataset.search).includes(term));
        });
    });
</script>
@endsection
