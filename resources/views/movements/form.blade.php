...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const filterAssets = () => {
            ...
            const matches = assetOptions.filter((option) => term === '' || normalize(option.dataset.search).includes(term));
