...
<form method="POST" class="card" action="{{ $asset->exists ? route('assets.update', $asset) : route('assets.store') }}">
    <div class="card-body">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6"><label class="form-label">Costo neto</label><input type="number" step=".01" min="0" name="costo_neto_actual" class="form-control" value="{{ old('costo_neto_actual', $asset->costo_neto_actual) }}"></div>
